#ifndef _Duplicate_171_
#define _Duplicate_171_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_171{
public:
	Duplicate_171(Buffer<streamData>& dup28_0,Buffer<streamData>& dup28_1,Buffer<streamData>& In):dup28_0(dup28_0),dup28_1(dup28_1),In(In){
