#ifndef _Duplicate_63_
#define _Duplicate_63_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_63{
public:
	Duplicate_63(Buffer<streamData>& dup10_0,Buffer<streamData>& dup10_1,Buffer<streamData>& In):dup10_0(dup10_0),dup10_1(dup10_1),In(In){
