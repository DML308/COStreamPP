#ifndef _Duplicate_111_
#define _Duplicate_111_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_111{
public:
	Duplicate_111(Buffer<streamData>& dup18_0,Buffer<streamData>& dup18_1,Buffer<streamData>& In):dup18_0(dup18_0),dup18_1(dup18_1),In(In){
