#ifndef _Duplicate_183_
#define _Duplicate_183_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_183{
public:
	Duplicate_183(Buffer<streamData>& dup30_0,Buffer<streamData>& dup30_1,Buffer<streamData>& In):dup30_0(dup30_0),dup30_1(dup30_1),In(In){
