#ifndef _Duplicate_147_
#define _Duplicate_147_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_147{
public:
	Duplicate_147(Buffer<streamData>& dup24_0,Buffer<streamData>& dup24_1,Buffer<streamData>& In):dup24_0(dup24_0),dup24_1(dup24_1),In(In){
