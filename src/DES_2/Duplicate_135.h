#ifndef _Duplicate_135_
#define _Duplicate_135_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_135{
public:
	Duplicate_135(Buffer<streamData>& dup22_0,Buffer<streamData>& dup22_1,Buffer<streamData>& In):dup22_0(dup22_0),dup22_1(dup22_1),In(In){
