#ifndef _Duplicate_123_
#define _Duplicate_123_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_123{
public:
	Duplicate_123(Buffer<streamData>& dup20_0,Buffer<streamData>& dup20_1,Buffer<streamData>& In):dup20_0(dup20_0),dup20_1(dup20_1),In(In){
