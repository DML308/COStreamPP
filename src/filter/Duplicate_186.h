#ifndef _Duplicate_186_
#define _Duplicate_186_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_186{
public:
	Duplicate_186(Buffer<streamData>& dup21_0,Buffer<streamData>& dup21_1,Buffer<streamData>& In):dup21_0(dup21_0),dup21_1(dup21_1),In(In){
