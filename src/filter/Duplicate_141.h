#ifndef _Duplicate_141_
#define _Duplicate_141_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_141{
public:
	Duplicate_141(Buffer<streamData>& dup16_0,Buffer<streamData>& dup16_1,Buffer<streamData>& In):dup16_0(dup16_0),dup16_1(dup16_1),In(In){
