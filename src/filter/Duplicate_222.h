#ifndef _Duplicate_222_
#define _Duplicate_222_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_222{
public:
	Duplicate_222(Buffer<streamData>& dup25_0,Buffer<streamData>& dup25_1,Buffer<streamData>& In):dup25_0(dup25_0),dup25_1(dup25_1),In(In){
