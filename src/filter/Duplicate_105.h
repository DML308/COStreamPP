#ifndef _Duplicate_105_
#define _Duplicate_105_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_105{
public:
	Duplicate_105(Buffer<streamData>& dup12_0,Buffer<streamData>& dup12_1,Buffer<streamData>& In):dup12_0(dup12_0),dup12_1(dup12_1),In(In){
