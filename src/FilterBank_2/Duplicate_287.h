#ifndef _Duplicate_287_
#define _Duplicate_287_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_287{
public:
	Duplicate_287(Buffer<streamData>& dup29_0,Buffer<streamData>& dup29_1,Buffer<streamData>& In):dup29_0(dup29_0),dup29_1(dup29_1),In(In){
