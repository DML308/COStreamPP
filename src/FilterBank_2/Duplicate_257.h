#ifndef _Duplicate_257_
#define _Duplicate_257_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_257{
public:
	Duplicate_257(Buffer<streamData>& dup26_0,Buffer<streamData>& dup26_1,Buffer<streamData>& In):dup26_0(dup26_0),dup26_1(dup26_1),In(In){
