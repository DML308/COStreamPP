#ifndef _Duplicate_97_
#define _Duplicate_97_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_97{
public:
	Duplicate_97(Buffer<streamData>& dup10_0,Buffer<streamData>& dup10_1,Buffer<streamData>& In):dup10_0(dup10_0),dup10_1(dup10_1),In(In){
