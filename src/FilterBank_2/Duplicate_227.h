#ifndef _Duplicate_227_
#define _Duplicate_227_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_227{
public:
	Duplicate_227(Buffer<streamData>& dup23_0,Buffer<streamData>& dup23_1,Buffer<streamData>& In):dup23_0(dup23_0),dup23_1(dup23_1),In(In){
