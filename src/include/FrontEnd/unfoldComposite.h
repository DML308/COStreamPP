...
class UnfoldComposite
{
  public:
    ...
    Node* makeConv2DKernelBody(layerNode *layer, list<Node *> *inputs, list<Node *> *outputs, Node *kernelIndex);
    Node* makeConv2DKernelOperInit(layerNode *layer, Node *kernelndex);
    Node* makeConv2DKernelOperWork(layerNode *layer, list<Node *> *inputs, list<Node *> *outputs, Node *kernelIndex);
    operatorNode* makeConv2DKernelOper(layerNode *layer, list<Node *> *inputs, list<Node *> *outputs, Node *kernelndex);
    ...
    compositeNode* makeDConv2DKernel(layerNode *layer, list<Node *> *inputs, list<Node *> *outputs, Node *kernelIndex);
