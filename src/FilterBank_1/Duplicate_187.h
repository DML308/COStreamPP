#ifndef _Duplicate_187_
#define _Duplicate_187_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_187{
public:
	Duplicate_187(Buffer<streamData>& dup19_0,Buffer<streamData>& dup19_1,Buffer<streamData>& In):dup19_0(dup19_0),dup19_1(dup19_1),In(In){
