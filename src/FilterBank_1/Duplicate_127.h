#ifndef _Duplicate_127_
#define _Duplicate_127_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_127{
public:
	Duplicate_127(Buffer<streamData>& dup13_0,Buffer<streamData>& dup13_1,Buffer<streamData>& In):dup13_0(dup13_0),dup13_1(dup13_1),In(In){
