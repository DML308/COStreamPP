#ifndef _Duplicate_107_
#define _Duplicate_107_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_107{
public:
	Duplicate_107(Buffer<streamData>& dup11_0,Buffer<streamData>& dup11_1,Buffer<streamData>& In):dup11_0(dup11_0),dup11_1(dup11_1),In(In){
