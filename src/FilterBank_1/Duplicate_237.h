#ifndef _Duplicate_237_
#define _Duplicate_237_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_237{
public:
	Duplicate_237(Buffer<streamData>& dup24_0,Buffer<streamData>& dup24_1,Buffer<streamData>& In):dup24_0(dup24_0),dup24_1(dup24_1),In(In){
