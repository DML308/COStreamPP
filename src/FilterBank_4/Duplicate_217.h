#ifndef _Duplicate_217_
#define _Duplicate_217_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_217{
public:
	Duplicate_217(Buffer<streamData>& dup22_0,Buffer<streamData>& dup22_1,Buffer<streamData>& In):dup22_0(dup22_0),dup22_1(dup22_1),In(In){
