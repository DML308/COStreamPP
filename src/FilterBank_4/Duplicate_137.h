#ifndef _Duplicate_137_
#define _Duplicate_137_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_137{
public:
	Duplicate_137(Buffer<streamData>& dup14_0,Buffer<streamData>& dup14_1,Buffer<streamData>& In):dup14_0(dup14_0),dup14_1(dup14_1),In(In){
