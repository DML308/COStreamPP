#ifndef _Duplicate_177_
#define _Duplicate_177_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_177{
public:
	Duplicate_177(Buffer<streamData>& dup18_0,Buffer<streamData>& dup18_1,Buffer<streamData>& In):dup18_0(dup18_0),dup18_1(dup18_1),In(In){
