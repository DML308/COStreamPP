#ifndef _Duplicate_117_
#define _Duplicate_117_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_117{
public:
	Duplicate_117(Buffer<streamData>& dup12_0,Buffer<streamData>& dup12_1,Buffer<streamData>& In):dup12_0(dup12_0),dup12_1(dup12_1),In(In){
