#ifndef _Duplicate_277_
#define _Duplicate_277_
#include <string>
#include <iostream>
#include "Buffer.h"
#include "Consumer.h"
...
class Duplicate_277{
public:
	Duplicate_277(Buffer<streamData>& dup28_0,Buffer<streamData>& dup28_1,Buffer<streamData>& In):dup28_0(dup28_0),dup28_1(dup28_1),In(In){
